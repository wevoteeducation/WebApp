  ...
  render () {
    ...
    return <div>
      ...
      <div className="container-fluid well">
        ...
        <span>
          <OpenExternalWebSite url="https://WeVote.me/"
                             target="_blank"
        ...
        <p><span>We also use third-party services such as Google Analytics </span>
          <span>(<OpenExternalWebSite url="https://policies.google.com/privacy"
                             target="_blank"
                             body={<span>https://policies.google.com/privacy</span>} />)</span>
          <span> and Full Story (<OpenExternalWebSite url="https://www.fullstory.com/legal/privacy/"
                             target="_blank"
                             body={<span>https://www.fullstory.com/legal/privacy/</span>} />).</span>
        ...
        <p><span>The information generated about your use of our Site (including your IP address) is transmitted to and stored by Google and Full Story on servers in the United States. Google and/or Full Story may also transfer this information to third parties where Google and/or Full Story are legally required, or where such third parties process the information on Google’s or Full Story's behalf. Google may combine your IP address with any other data held by Google. By using this Site, you consent to the processing of data by Google and Full Story in the manner and for the purposes set out above.</span>
        </p>
