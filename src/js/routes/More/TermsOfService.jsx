  ...
  render () {
    ...
    return <div>
      ...
      <div className="container-fluid well">
        <h1 className="text-center">WeVote.me Terms of Service</h1>
        <p><strong>Last updated: July 2, 2018</strong></p>

            <h2>Overview</h2>
            <p>This website (also packaged in mobile apps) is operated by We Vote. Throughout the site, the terms “We Vote”, “we”, “us” and “our” refer to We Vote USA. We Vote USA offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
            ...
            <p>Your submission of personal information is governed by our <Link to="/more/privacy">Privacy Policy</Link>.</p>
        ...
        <p><span>If you have any questions about the Terms of Service, you may contact us by sending an e-mail to <a href="mailto:info@WeVote.me" target="_blank">info@WeVote.me</a> </span><br />
          <span>You can also write to us at the following address:</span>
        </p>
        <p>We Vote Education
          <br /> 1717 Clemens Rd
          <br /> Oakland, CA 94602
          <br /> Attn: Terms of Service
        </p>
        <p>&nbsp;</p>
      </div>
    </div>;
